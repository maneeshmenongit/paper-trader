...
|---|---:|---:|
| always_momentum (floor) | $2,110.90 | — |
| null_selector (real bar) | $2,110.90 | — |
| random_among_eligible | $5,138.41 | — |
| **llm_selector** | **$255.58** | 382 |
| oracle_best_method (hindsight) | $88,443.33 | — |
| ceiling (perfect foresight) | $116,808.97 | — |

## 3. LLM edge (over the EFFECTIVE floor)

- Effective floor = max(momentum $2,110.90, null $2,110.90) = **$556.75**.
...
- LLM calls: **600** · cache hits: 0 · tokens: 180,866.
